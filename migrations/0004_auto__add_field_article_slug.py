...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('djTreesaver_article', 'slug', self.gf('django.db.models.fields.CharField')(default='hello', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.slug'
        db.delete_column('djTreesaver_article', 'slug')
