...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.grid'
        db.add_column('djTreesaver_article', 'grid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djTreesaver.Grid'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.grid'
        db.delete_column('djTreesaver_article', 'grid_id')
