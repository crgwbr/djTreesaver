...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Grid.sass'
        db.add_column('djTreesaver_grid', 'sass', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Grid.sass'
        db.delete_column('djTreesaver_grid', 'sass')
