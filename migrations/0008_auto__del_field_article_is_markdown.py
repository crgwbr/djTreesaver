...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Article.is_markdown'
        db.delete_column('djTreesaver_article', 'is_markdown')


    def backwards(self, orm):
        
        # Adding field 'Article.is_markdown'
        db.add_column('djTreesaver_article', 'is_markdown', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        'djTreesaver.article': {
            ...
            'grid': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['djTreesaver.Grid']", 'null': 'True', 'blank': 'True'}),
        ...
        'djTreesaver.grid': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sass': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
        'djTreesaver.image': {
